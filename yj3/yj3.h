const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	*/
	...
	/*
		...
		|---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------|
		|  TO.9   |    z    |    x    |    c    |    v    |    b    |  TG.3   |  TG.3   |    n    |    m    |  ,  <   |  .  >   |  /  ?   |  TO.9   |
		|---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------|
		|  LAlt   |  Reset  |  TO.15  |  LGUI   |  Eisu   |   Spc   |  TG.4   |  TG.5   |   Spc   |  Kana   |  RGUI   |  TG.2   |  DF.1   |  DF.0   |
		+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+
	*/
	...
	*/
	...
	/*
		...
		|---------+---------+---------+---------+---------+---------+         +         +---------+---------+---------+---------+---------+---------|
		|   ---   | RGB_M_P | RGB_M_X | RGB_M_G | Saido-  | Saido+  |                   |   ---   | L Click | C Click | R Click | Wheel U |   ---   |
		|---------+---------+---------+---------+---------+---------+         +         +---------+---------+---------+---------+---------+---------|
		|   ---   |RGB_M_SN | RGB_M_B | RGB_M_R | Meido-  | Meido+  |                   | Mouse L | Mouse D | Mouse U | Mouse R | Wheel D |   ---   |
		|---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------|
		|   mac   |RGB_M_SW | Effect- | Effect+ | Shodo-  | Shodo+  |  Trans  |  Trans  |   ---   |   ---   |   ---   |   ---   |   ---   |   ---   |
		|---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------|
		|   win   |   ---   |   ---   |   ---   | Eff Sp- | Eff Sp+ | LED SW  |  Reset  | E Reset |   ---   |   ---   |   ---   |  DF.1   |  DF.0   |
		+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+
	*/
	[3] = LAYOUT(KC_F1,KC_F2,KC_F3,KC_F4,KC_F5,KC_F6,KC_F7,KC_F8,KC_F9,KC_F10,KC_F11,KC_F12,KC_NO,RGB_M_P,RGB_M_X,RGB_M_G,RGB_SAD,RGB_SAI,KC_NO,KC_BTN1,KC_BTN3,KC_BTN2,KC_WH_U,KC_NO,KC_NO,RGB_M_SN,RGB_M_B,RGB_M_R,RGB_HUD,RGB_HUI,KC_MS_L,KC_MS_D,KC_MS_U,KC_MS_R,KC_WH_D,KC_NO,AG_NORM,RGB_M_SW,RGB_RMOD,RGB_MOD,RGB_VAD,RGB_VAI,KC_TRNS,KC_TRNS,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,AG_SWAP,KC_NO,KC_NO,KC_NO,RGB_SPD,RGB_SPI,RGB_TOG,RESET,EEP_RST,KC_NO,KC_NO,KC_NO,DF(1,DF(0,),
	...
	/*
		...
		|---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------|
		|   ---   |   ---   |   ---   |   ---   | PrntScn | Insert  |  Trans  |  Trans  |  KC_AT  | KC_CIRC |   ---   |   ---   |   ---   |   ---   |
		|---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------|
		|   ---   |   ---   |   ---   |   ---   | E Reset |  Reset  |  Trans  |   ---   |   ---   |   ---   |   ---   |   ---   |  DF.1   |  DF.0   |
		+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+
	*/
	...
	/*
		...
		|---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------|
		| LShift  | KC_EXLM | KC_QUES | KC_HASH | KC_DLR  | KC_PERC |   ---   |   ---   |  KC_AT  | KC_CIRC |   ---   |   ---   |   ---   | LShift  |
		|---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------|
		|  LAlt   |   ---   |   ---   |  LGUI   |  Eisu   |   Spc   |  Trans  |  Trans  |   Spc   |  Kana   |  RGUI   |   ---   |  DF.1   |  DF.0   |
		+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+
	*/
	...
	*/
	...
	/*
		...
		|---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------|
		|  Trans  |   S z   |   S x   |   S c   |   S v   |   S b   |   ---   |   ---   |   S n   |   S m   | S ,  <  | S .  >  | S /  ?  |  Trans  |
		|---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------|
		|  LAlt   |   ---   |   ---   | S LGUI  |  Eisu   |  S Spc  |   ---   |   ---   |  S Spc  |  Kana   | S RGUI  |   ---   |  DF.1   |  DF.0   |
		+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+
	*/
	...
	*/
	...
	/*
		...
		+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+
	*/
	[10] = LAYOUT(KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,DF(1,DF(0,),
	...
	/*
		...
		+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+
	*/
	[11] = LAYOUT(KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,DF(1,DF(0,),
	...
	/*
		...
		+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+
	*/
	[12] = LAYOUT(KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,DF(1,DF(0,),
	...
	/*
		...
		+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+
	*/
	[13] = LAYOUT(KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,DF(1,DF(0,),
	...
	/*
		...
		+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+
	*/
	[14] = LAYOUT(KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,DF(1,DF(0,),
