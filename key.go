...
var KEYMAP = map[string]string{
	...
	"KC_TRANSPARENT": "bLayer", // Use the next lowest non-transparent key
	"KC_TRNS":        "bLayer", // Use the next lowest non-transparent key
	"_______":        "bLayer", // Use the next lowest non-transparent key
	...
	"KC_ESCAPE": "Escape",
	"KC_ESC":    "Escape", // "Escape",
	"KC_BSPACE": "BkSpace",
	"KC_BSPC":   "Bkspace", // "Delete (Backspace)",
	"KC_TAB":    "Tab",
	"KC_SPACE":  "Space",
	"KC_SPC":    "Spcace", // "Spacebar",
	...
	// テンキー {{{2
	"KC_NUMLOCK":        "k NLock", // "Keypad Num Lock / Clear",
	"KC_KP_SLASH":       "k /",
	"KC_KP_ASTERISK":    "k *",
	"KC_KP_MINUS":       "k -",
	"KC_KP_PLUS":        "k +",
	...
	"KC_KP_EQUAL":       "k =",
	"KC_PEQL":           "k =",
	"KC_KP_EQUAL_AS400": "k = on AS/400 keyboards",
	"KC_KP_COMMA":       "k ,",
	"KC_PCMM":           "Keypad ,",
	"KC_NLCK":           "k NLock Clear",
	"KC_PSLS":           "k /",
	"KC_PAST":           "k *",
	"KC_PMNS":           "k -",
	"KC_PPLS":           "k +",
